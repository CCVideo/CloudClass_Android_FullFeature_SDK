...
import static com.bokecc.ccsskt.example.R.id.id_inspector_class_user_list;
 ...
 */
@RuntimePermissions
public class InspectorActivity  extends BaseActivity implements OnDocInteractionListener, OnVideoInteractionListener, OnDisplayInteractionListener,View.OnClickListener{
    private static final String TAG = InspectorActivity.class.getSimpleName();

    @BindView(R.id.id_inspector_other_layout)
    RelativeLayout mOtherScenes;
    @BindView(R.id.id_inspector_noclass_layout)
    LinearLayout mNoClassLayout;
    @BindView(R.id.id_inspector_teacher_gone_layout)
    RelativeLayout mTeacherGoneLayout;
    @BindView(id_inspector_class_user_list)
    View mClassMsg;
    TextView mClassName;
    TextView mClassUserNum;
//    ImageView mClassHandIcon;
//    ImageView mClassArrowIcon;
    @BindView(R.id.id_inspector_top_layout)
    RelativeLayout mTopLayout;
    @BindView(R.id.id_inspector_video_controller)
    ImageButton mVideoController;
    @BindView(R.id.id_inspector_timer)
    RelativeLayout mRoomTimerLayout;
    @BindView(R.id.id_inspector_timer_value)
    TextView mTimerValue;
    @BindView(R.id.id_student_bottom_layout)
    RelativeLayout mBottomLayout;
//    @BindView(R.id.id_student_lianmaistyle)
//    Button mLianmaiStyle;
    @BindView(R.id.id_inspector_click_dismiss_chat)
    FrameLayout mClickDismissChatLayout;
    @BindView(R.id.id_inspector_chat_layout)
    RelativeLayout mChatLayout;
    @BindView(R.id.id_inspector_chat_list)
    RecyclerView mChatList;
    @BindView(R.id.id_inspector_chat_input)
    EditText mChatInput;
//    @BindView(R.id.id_student_chat)
//    Button mChatBtn;
    @BindView(R.id.id_inspector_chat_img_fullscreen_layout)
    RelativeLayout mChatImageLayout;
    @BindView(R.id.id_inspector_chat_img)
    ImageView mChatImage;
//    @BindView(R.id.id_inspector_drag_child)
//    LinearLayout mDrawLayout;
//    @BindView(R.id.id_inspector_draw_paint)
//    ImageButton mDrawPaint;
//    @BindView(R.id.id_inspector_draw_clear)
//    ImageButton mDrawClear;
//    @BindView(R.id.id_inspector_draw_tbc)
//    ImageButton mDrawTBC;
//    @BindView(R.id.id_student_handup)
//    Button mHandup;
    @BindView(R.id.id_inspector_share_screen_container)
    FrameLayout mShareScreenContainer;
    @BindView(R.id.id_inspector_share_screen)
    CCSurfaceRenderer mShareScreen;
    @BindView(R.id.id_inspector_share_screen_exit)
    ImageView mShareScreenExit;
    @BindView(R.id.id_inspector_remote_video_container)
    FrameLayout mRemoteVideoContainer;
    @BindView(R.id.id_inspector_remote_video)
    SurfaceView mRemoteVideo;
    @BindView(R.id.id_inspector_remote_video_exit)
    ...
    protected void onViewCreated() {
        mAppPlayUrl = mSPUtil.getString(ValidateActivity.KEY_APP_PLAY_URL, "");//获取暖场视频url
        ...
        if (!mInteractSession.isRoomLive()) {
            ...
            if (!TextUtils.isEmpty(mAppPlayUrl)) {
                ...
                initMediaPlayer(mAppPlayUrl);
                bufferProgressBar.setVisibility(View.VISIBLE);
                mWarmUpVideoLayout.setVisibility(View.VISIBLE);
            } else {
    ...
    private void doRemoteVideoLayoutTouch() {
        ...
        final GestureDetector gestureDetector = new GestureDetector(new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onDoubleTap(MotionEvent e) {
                ...
                int height = DensityUtil.getWidth(InspectorActivity.this) * mPlayerMap.get("videoMedia")
                        .getVideoHeight() / mPlayerMap.get("videoMedia").getVideoWidth();
            ...
            public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
                ...
                if (params.topMargin > (DensityUtil.getHeight(InspectorActivity.this) - mRemoteVideo.getHeight()
                        - DensityUtil.dp2px(InspectorActivity.this, 30))) {
                    params.topMargin = DensityUtil.getHeight(InspectorActivity.this) - mRemoteVideo.getHeight() - DensityUtil.dp2px(InspectorActivity.this, 30);
                }
                if (params.leftMargin > (DensityUtil.getWidth(InspectorActivity.this) - mRemoteVideo.getWidth())) {
                    params.leftMargin = DensityUtil.getWidth(InspectorActivity.this) - mRemoteVideo.getWidth();
                }
    ...
    private void doShareScreenLayoutTouch() {
        ...
        final GestureDetector gestureDetector = new GestureDetector(new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
                ...
                if (params.topMargin > (DensityUtil.getHeight(InspectorActivity.this) - mShareScreenContainer.getHeight()
                        - DensityUtil.dp2px(InspectorActivity.this, 30))) {
                    params.topMargin = DensityUtil.getHeight(InspectorActivity.this) - mShareScreenContainer.getHeight() - DensityUtil.dp2px(InspectorActivity.this, 30);
                }
                if (params.leftMargin > (DensityUtil.getWidth(InspectorActivity.this) - mShareScreenContainer.getWidth())) {
                    params.leftMargin = DensityUtil.getWidth(InspectorActivity.this) - mShareScreenContainer.getWidth();
                }
                mShareScreenContainer.setLayoutParams(params);
                return super.onScroll(e1, e2, distanceX, distanceY);
            }
    ...
    protected void onResume() {
        ...
        if (mWarmVideoPlayer != null && !TextUtils.isEmpty(mAppPlayUrl) && currentPosition != 0) {
//                initMediaPlayer(mAppPlayUrl);
...
//        }
    ...
    private void compressBitmap(String imgPath, int degree) {
        ...
        images.add(image);
        CompressImage compressImage = CompressImageImpl.of(this, config, images, new InspectorActivity.MyCompressListener(degree));
...
//                break;
            ...
            case Config.INTERACT_EVENT_WHAT_KICK_OUT:
                ...
                ValidateActivity.startSelf(this, mRoomDes.getName(), mRoomDes.getDesc(),
                        mRoomId, mUserId, CCInteractSession.INSPECTOR, mRoomDes.getAuthtype() == 2);
                finish();
                break;
        }
    }
...
//            ((IjkMediaPlayer) mWarmVideoPlayer).setOption(IjkMediaPlayer.OPT_CATEGORY_PLAYER, "enable-accurate-seek", 1);
            mWarmVideoPlayer.setLooping(true); // 设置循环播放
            mWarmVideoPlayer.setScreenOnWhilePlaying(true);
            mWarmVideoPlayer.setAudioStreamType(AudioManager.STREAM_MUSIC);
//            ((IjkMediaPlayer) mWarmVideoPlayer).setOption(IjkMediaPlayer.OPT_CATEGORY_PLAYER, "mediacodec", 1);
...
//            ((IjkMediaPlayer)player).setOption(IjkMediaPlayer.OPT_CATEGORY_PLAYER, "mediacodec", 1);
            ...
            player.setOnPreparedListener(new IMediaPlayer.OnPreparedListener() {
                ...
                public void onPrepared(IMediaPlayer mp) {
                    ...
                    if (mPlayerType.get(mp)) {
                        ...
                        params.width = DensityUtil.dp2px(InspectorActivity.this, 160);
                        params.height = DensityUtil.dp2px(InspectorActivity.this, 90);
                        mRemoteVideoContainer.setLayoutParams(params);
                    }
    ...
    private void dismissShareScreen(SubscribeRemoteStream stream) {
        try {
            ...
            RelativeLayout.LayoutParams temp = new RelativeLayout.LayoutParams(DensityUtil.dp2px(InspectorActivity.this, 160), DensityUtil.dp2px(InspectorActivity.this, 90));
            temp.leftMargin = 0;
            temp.topMargin = 0;
            mShareScreenContainer.setLayoutParams(temp);
            FrameLayout.LayoutParams videoParams = new FrameLayout.LayoutParams(DensityUtil.dp2px(InspectorActivity.this, 160), DensityUtil.dp2px(InspectorActivity.this, 90));
            videoParams.gravity = Gravity.CENTER;
            mShareScreen.setLayoutParams(videoParams);
        }
    }
    ...
    private synchronized void setSelected(int template) {
        ...
        getSupportFragmentManager().beginTransaction().
                replace(R.id.id_inspector_content, mCurFragment)
    ...
    private void finishGoHome() {
        ...
        ValidateActivity.startSelf(this, mRoomDes.getName(), mRoomDes.getDesc(), mRoomId,
                mUserId, CCInteractSession.INSPECTOR, mRoomDes.getAuthtype() == 2);
        finish();
    }
    ...
    @OnClick(R.id.id_inspector_share_screen_exit)
    ...
    @OnClick(R.id.id_inspector_remote_video_exit)
    ...
    @OnClick(id_inspector_class_user_list)
    void classUserList() {
        ListActivity.startSelf(this, CCInteractSession.INSPECTOR, mCount);
    }

    @OnClick(R.id.id_inspector_close)
    void close() {
        mExitPopup.show(mRoot);
    }

    @OnClick(R.id.id_inspector_video_controller)
    ...
    @OnClick(R.id.id_inspector_chat_img_fullscreen_layout)
    void dismissChatImage() {
        mChatImageLayout.setVisibility(View.GONE);
    }

    @OnClick(R.id.id_inspector_click_dismiss_chat)
...
//    Pattern pattern = Pattern.compile("(([hH][tT]{2}[pP]|[hH][tT]{2}[pP][sS])://|(www))(([a-zA-Z0-9\\._-]+\\.[a-zA-Z]{2,6})|([0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}))(:[0-9]{1,4})*(/[a-zA-Z0-9\\&%_\\./-~-]*)?");
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        InspectorActivityPermissionsDispatcher.onRequestPermissionsResult(this, requestCode, grantResults);
    }
