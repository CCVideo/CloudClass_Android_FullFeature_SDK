...
//                throw new NullPointerException("课堂链接错误");
            ...
            CCInteractSession.getInstance().getRoomMsg(mRoomId, new CCInteractSession
                    .AtlasCallBack<String>() {
                @Override
...
//                                ValidateActivity.startSelf(context, mRoomDes.getName(), mRoomDes.getDesc(), mRoomId, mUserId, CCInteractSession.PRESENTER, false);
                            ...
                            case "inspector":
                                ...
                                DirectionActivity.startSelf(context, CCInteractSession.INSPECTOR, mUserId, mRoomId, mRoomDes);
                                break;
                            default:
                                if (callBack != null) {
